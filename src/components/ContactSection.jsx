    ...
    return (
        ...
        >   <div className="container mx-auto max-w-5xl">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
                    Dus wat <span className="text-primary"> zeg </span> je ervan?
                </h2>
                <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                    Als je dit leest heb ik je aandacht toch een flinke tijd vastgehouden. Zullen we kijken of ik dat ook voor je doelgroep kan doen?
                </p>
